...
class PipelineTab(TabBase):
    ...
    def _create_ui(self) -> None:
        ...
        self._tree.heading("Population", text="Population", command=lambda: self._sort_column("Population"))
    ...
    def bulk_move(self, population: str) -> None:
        ...
        if not messagebox.askyesno("Confirm Move",
            f"Move {len(selected)} prospects to {population}?"):
            return
    ...
    def bulk_park(self, month: str) -> None:
        ...
        if not messagebox.askyesno("Confirm Park",
            f"Park {len(selected)} prospects until {month}?"):
            return
    ...
    def _on_double_click(self, event) -> None:
        ...
        self._show_prospect_details(prospect_id)
    ...
    def _show_prospect_details(self, prospect_id: int) -> None:
        ...
        try:
            ...
            text.insert(tk.END, f"Population: {prospect.population.value if prospect.population else 'N/A'}\n")
